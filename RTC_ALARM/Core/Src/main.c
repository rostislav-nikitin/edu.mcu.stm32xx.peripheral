...
void RTC_CalendarCofig(void)
{
	...
	//Ex3
	rtc_time_init.Hours = 7U;
	rtc_time_init.Minutes = 59U;
	rtc_time_init.Seconds = 50U;
...
void RTC_AlarmConfig(void)
{
	...
	rtc_alarm_init.AlarmTime.Hours = 8U;
	rtc_alarm_init.AlarmTime.Minutes = 00U;
	rtc_alarm_init.AlarmTime.Seconds = 00U;
	rtc_alarm_init.AlarmTime.TimeFormat = RTC_HOURFORMAT12_AM;
	rtc_alarm_init.AlarmSubSecondMask = RTC_ALARMSUBSECONDMASK_NONE;
	rtc_alarm_init.AlarmMask = RTC_ALARMMASK_NONE;
